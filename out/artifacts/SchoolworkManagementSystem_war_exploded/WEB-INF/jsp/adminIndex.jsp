...
<div class="pageContainer">
    ...
    <div class="pageSidebar">
        <ul class="nav nav-stacked nav-pills">
            <li role="presentation">
                <a href="/Teacher/allTeacher" target="mainFrame">管理老师</a>
            </li>
            <li role="presentation">
                <a href="/Student/allStudent" target="mainFrame" >管理学生</a>
            </li>
            <li role="presentation">
    ...
    <div class="pageContent">
        <iframe src="/Teacher/allTeacher" id="mainFrame" name="mainFrame"
