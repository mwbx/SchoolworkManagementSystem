...
<div class="pageContainer">
    ...
    <div class="pageSidebar">
        <ul class="nav nav-stacked nav-pills">
            <li role="presentation">
                <a href="${pageContext.request.contextPath}/TCS/selectMyCourse?teacherAccount=${sessionScope.Login.loginAccount}" target="mainFrame">查看课程</a>
            </li>
            <li role="presentation">
    ...
    <div class="pageContent">
        <iframe src="${pageContext.request.contextPath}/TCS/selectMyCourse?teacherAccount=${sessionScope.Login.loginAccount}" id="mainFrame" name="mainFrame"
